...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/search_small.svg
  SvgGenImage get searchSmall =>
      const SvgGenImage('assets/icons/search_small.svg');
  ...
  List<SvgGenImage> get values =>
      [checked, empty, logo, plus, search, searchSmall, todo];
}
...
class Assets {
  ...
  static const String package = 'taski_challenger_app';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/taski_challenger_app/$_assetName';
}
